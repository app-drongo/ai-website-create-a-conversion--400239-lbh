...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/company/enterpriseflow" },
    { name: "Twitter", icon: Twitter, href: "https://twitter.com/enterpriseflow" },
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/enterpriseflow" },
    { name: "GitHub", icon: Github, href: "https://github.com/enterpriseflow" }
  ]
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                <div className="size-10 rounded-lg bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center">
                  <span className="text-background font-bold">EF</span>
                </div>
                <span className="font-bold text-xl text-foreground">EnterpriseFlow</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Leading SAP consulting firm specializing in enterprise digital transformation. 
                We help businesses optimize their operations with cutting-edge SAP solutions and expert project management.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">contact@enterpriseflow.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">+1 (555) 847-3200</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-primary flex-shrink-0" />
                <span className="text-muted-foreground">Enterprise Plaza, 500 Business Center Dr</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get expert SAP insights and industry updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 EnterpriseFlow SAP Solutions. All rights reserved.</span>
              <span className="hidden sm:inline">•</span>
              <span className="hidden sm:inline flex items-center gap-1">
                Certified SAP Partner <Heart className="size-3 text-accent fill-current" />
              </span>
            </div>
