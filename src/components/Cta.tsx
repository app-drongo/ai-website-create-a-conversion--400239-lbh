...
export default function Cta() {
  const stats = [
    { value: "200+", label: "SAP Projects Delivered", icon: Award },
    { value: "99.2%", label: "On-Time Delivery", icon: Shield },
    { value: "15+", label: "Years SAP Expertise", icon: TrendingUp },
    { value: "24/7", label: "Project Support", icon: Users }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join Fortune 500 companies who trust EnterpriseFlow for their SAP implementations. 
                Let's discuss how we can optimize your enterprise systems and drive digital transformation.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Complimentary SAP landscape evaluation and roadmap
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Enterprise-grade project management with guaranteed outcomes
              </p>
            </div>
